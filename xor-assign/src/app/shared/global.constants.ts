...
export const DEFAULT_PROFILE_PIC = '../assets/images/default_profile_pic.jpg'

export const enum FORM_NAME_ENUM  {
  LOGIN_FORM = 1,
  SIGNUP_FORM = 2,
  USER_FORM = 3,
}

export const enum GENDER_TYPES_ENUM {
  MALE = 'MALE',
  FEMALE = 'FEMALE',
  OTHER = 'OTHER'
}
...
export const GENDER_TYPES = {
  MALE: GENDER_TYPES_ENUM.MALE,
  FEMALE: GENDER_TYPES_ENUM.FEMALE,
  OTHER: GENDER_TYPES_ENUM.OTHER
};
